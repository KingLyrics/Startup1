  ...
  return (
    <div className="py-48 px-4 max-w-[1240px] mx-auto">
      <div className="max-w-[1240px] mx-auto">
        ...
        <div className="max-w-5xl mt-14 mx-auto grid grid-cols-3 gap-4">
          <Card
            icon={<BsFillBriefcaseFill size={70} className="text-Action" />}
          ...
          />
          <Card
            icon={<FaCompressAlt size={70} className="text-Action" />}
          ...
          />
          <Card
            icon={<FaDesktop size={70} className="text-Action" />}
            title={"Retina Ready"}
            text={
